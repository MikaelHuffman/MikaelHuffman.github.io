...
const startCount = document.getElementById("btn-count-start");
const pauseCount = document.getElementById("btn-count-pause");
...
document.getElementById("btn-donations").onclick = () => {
    ...
    const donationPercent = totalDonation / goal * 100;
    ...
    if(donationPercent >= 100) {
        ...
        donationMessage.innerHTML = "Let's get donating!";
    }
